/**
 * Color mapping generated via ozh/github-colors which is a python script to pull in language color
 * data from GitHub. Please note that there are languages that GitHub does not have support for.
 */
export const GITHUB_LANGUAGE_COLORS: { [key: string]: { color: string | null, url: string } } = {
    "1C Enterprise": {
        "color": `#814CCC`,
